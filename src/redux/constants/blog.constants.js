...
export const REACTION_REQUEST = "BLOG.REACTION_REQUEST";
export const REACTION_REQUEST_SUCCESS = "BLOG.REACTION_REQUEST_SUCCESS";
export const REACTION_REQUEST_FAILURE = "BLOG.REACTION_REQUEST_FAILURE";

export const GET_PAGINATION_REQUEST = "BLOG.GET_PAGINATION_REQUEST";
export const GET_PAGINATION_REQUEST_SUCCESS =
  "BLOG.GET_PAGINATION_REQUEST_SUCCESS";
export const GET_PAGINATION_REQUEST_FAILURE =
  "BLOG.GET_PAGINATION_REQUEST_FAILURE";
...
export const GET_SELF_BLOG_REQUEST = "BLOG.GET_SELF_BLOG_REQUEST";
export const GET_SELF_BLOG_REQUEST_SUCCESS =
  "BLOG.GET_SELF_BLOG_REQUEST_SUCCESS";
export const GET_SELF_BLOG_REQUEST_FAILURE =
  "BLOG.GET_SELF_BLOG_REQUEST_FAILURE";
